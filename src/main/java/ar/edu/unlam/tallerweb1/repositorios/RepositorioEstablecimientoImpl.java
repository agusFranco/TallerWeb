...
//	Inserta Establecimientos a la BDD - MASIVO
	public void insertarDatosMasivos() {
		...
		listaObjetos.add(new Establecimiento("Establecimiento Neuquén", "Ubicacion 05",50000, 23, "Zona C", "Armando"));
		listaObjetos.add(new Establecimiento("Establecimiento Mendoza", "Ubicacion 06",10000, 65, "Zona B", "Nicolas"));
		listaObjetos.add(new Establecimiento("Establecimiento Jujuy", "Ubicacion 07",1000, 76, "Zona C", "Javier"));
		listaObjetos.add(new Establecimiento("Establecimiento San Luis", "Ubicacion 08",60000, 112, "Zona A", "Adrian"));
		listaObjetos.add(new Establecimiento("Establecimiento Río Negro", "Ubicacion 09",10500, 65, "Zona A", "Federico"));
		listaObjetos.add(new Establecimiento("Establecimiento La Pampa", "Ubicacion 10",50000, 134, "Zona B", "Agustin"));
