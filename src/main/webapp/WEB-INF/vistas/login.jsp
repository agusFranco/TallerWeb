				...
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							...
							<form action="/TallerWeb/IniciarsesionDesarrollo" method="POST">
								<button type="submit" class="btn btn-info btn-lg btn-block">Iniciar
									sesión como desarrollador</button>
							</form>
