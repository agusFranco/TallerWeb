					...
					<div class="col-lg-3">
						<div class="contact-box">
							<a>
								...
								<div class="col-sm-8">
									<h3>
										<strong>${item.responsable.nombre}
											${item.responsable.apellido}</strong>
									</h3>
									<p>
									...
									<address>
										<strong>Datos Personales:</strong><br> Edad:
										${item.responsable.edad}<br> Identificador:
										${item.responsable.id} <br> Zona:
										${item.responsable.zona.nombre}
									</address>
								</div>
